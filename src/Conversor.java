    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                switch (opcion) {
                    case 1:
                        url = "https://v6.exchangerate-api.com/v6/df301eb3162121f157048095/pair/USD/ARS";
                        monedaOrigen = "USD";
                        monedaDestino = "ARS";
                        break;
                    case 2:
                        url = "https://v6.exchangerate-api.com/v6/df301eb3162121f157048095/pair/ARS/USD";
                        monedaOrigen = "ARS";
                        monedaDestino = "USD";
                        break;
                    case 3:
                        url = "https://v6.exchangerate-api.com/v6/df301eb3162121f157048095/pair/USD/BRL";
                        monedaOrigen = "USD";
                        monedaDestino = "BRL";
                        break;
                    case 4:
                        url = "https://v6.exchangerate-api.com/v6/df301eb3162121f157048095/pair/BRL/USD";
                        monedaOrigen = "BRL";
                        monedaDestino = "USD";
                        break;
                    case 5:
                        url = "https://v6.exchangerate-api.com/v6/df301eb3162121f157048095/pair/USD/COP";
                        monedaOrigen = "USD";
                        monedaDestino = "COP";
                        break;
                    case 6:
                        url = "https://v6.exchangerate-api.com/v6/df301eb3162121f157048095/pair/COP/USD";
                        monedaOrigen = "COP";
                        monedaDestino = "USD";
                        break;
                }
